...
const Board = () => {
    ...
    return (
            <div className={`${classes.board_container} ${__PLATFORM__ === 'desktop' ? classes.board_container_desktop : classes.board_container_mobile}`.trim()}>
                ...
                closeLinkInspector={closeLinkInspector}
                deleteSelectedLink={deleteSelectedLink}
                effectiveBoardMenuOpen={effectiveBoardMenuOpen}
                failedBoardImageSrc={failedBoardImageSrc}
                failedParticipantAvatarSrcs={failedParticipantAvatarSrcs}
                flipSelectedLinkDirection={flipSelectedLinkDirection}
                guests={guests}
                isBoardMetaLoading={isBoardMetaLoading}
                isInitialized={isInitialized}
                isLoggedIn={isLoggedIn}
                isOwner={isOwner}
                isOwnerBoard={isOwnerBoard}
                isGuestBoard={isGuestBoard}
                ...
                loadedBoardImageSrc={loadedBoardImageSrc}
                ...
                patchSelectedLinkDraft={patchSelectedLinkDraft}
                removeConfirmParticipantId={removeConfirmParticipantId}
                removeLoadingParticipantId={removeLoadingParticipantId}
                removeParticipant={removeParticipant}
                roleDropdownParticipantId={roleDropdownParticipantId}
                roleLoadingParticipantId={roleLoadingParticipantId}
                saveSelectedLink={saveSelectedLink}
                selectedCardDetails={selectedCardDetails}
                selectedLink={selectedLink}
                selectedLinkDraft={selectedLinkDraft}
                setFailedParticipantAvatarSrcs={setFailedParticipantAvatarSrcs}
                setLeaveConfirmOpen={setLeaveConfirmOpen}
                setLinkDeleteConfirmOpen={setLinkDeleteConfirmOpen}
                setLinkStyleDropdownOpen={setLinkStyleDropdownOpen}
                setLoadedParticipantAvatarSrcs={setLoadedParticipantAvatarSrcs}
                setRemoveConfirmParticipantId={setRemoveConfirmParticipantId}
                setRoleDropdownParticipantId={setRoleDropdownParticipantId}
                shouldShowOwnerActions={shouldShowOwnerActions}
                shouldShowParticipants={shouldShowParticipants}
